...
const page: FC<pageProps> = ({ }) => {
        ...
        <main className='font-roboto'>
            ...
            <section className='flex justify-center items-end pt-10 md:px-44 md:mb-10'>
                <div className='border h-96 p-10 rounded-2xl'>
                    ...
                    <div className='w-full  flex justify-between shadow-lg items-center cursor-pointer border  rounded-md p-2 my-2' onClick={() => customSignIn('google', `https://code-career.vercel.app/bussines/bussines-dashboard`)}>
	...
	c-5.202,0-9.619-3.317-11.283-7.946l-6.522,5.025C9.505,39.556,16.227,44,24,44z"></path><path fill="#1976D2" d="M43.611,20.083H42V20H24v8h11.303c-0.792,2.237-2.231,4.166-4.087,5.571
	            c0.001-0.001,0.002-0.001,0.003-0.002l6.19,5.238C36.971,39.205,44,34,44,24C44,22.659,43.862,21.35,43.611,20.083z"></path></svg>
                    ...
                    <div className='w-full flex justify-between shadow-lg items-center cursor-pointer border  rounded-md p-2 my-2' onClick={() => signIn('github', { callbackUrl: "https://code-career.vercel.app/bussines/bussines-dashboard" })}>
