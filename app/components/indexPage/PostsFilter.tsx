    ...
    return (
        <section>
            <section>
                ...
                <form >
                    <input
                    value={locationInput} onChange={(e) => setlocationInput(e.target.value)}  className='mr-2 shadow-inner shadow-gray-400 rounded-3xl p-1 pl-2 focus:outline-none focus:ring-2 focus:ring-[#67ae9a]' placeholder='Ort' type="text" name="location" id="location" list="location-suggestions" />
