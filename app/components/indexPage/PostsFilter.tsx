...
const PostsFilter: FC<PostsFilterProps> = ({ setSearchTerm, setLongitude, setLatitude, setRadius }) => {
    ...
    const debouncedSearchTerm = _.debounce(() => getGeolocation(locationInput), 200);
...
{/*                     <button type='submit'>
                ...
                <section>
                    <p>Radius</p>
                    <button onClick={() => setRadius(10)} className='border p-2 '>10km</button>
                    <button onClick={() => setRadius(25)} className='border p-2 '>25km</button>
                    <button onClick={() => setRadius(50)} className='border p-2 '>50km</button>
                    <button onClick={() => setRadius(100)} className='border p-2 '>100km</button>
                    <button onClick={() => setRadius("remote")} className='border p-2 '>remote</button>
                </section>
            </section>
        </section>
    )
