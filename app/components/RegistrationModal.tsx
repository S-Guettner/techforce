    ...
    <div className='bg-neutral-200 w-1/2 h-3/4 p-4'>
      ...
      <section className=''>
        <div className='border-2 border-red-600 p-2'>
          ...
          <div className=' w-2/3 flex justify-between cursor-pointer border-2 border-neutral-500 rounded-md p-2 my-2' onClick={() => signIn('github', { callbackUrl: "http://localhost:3000/bussines/bussines-dashboard" })}>
