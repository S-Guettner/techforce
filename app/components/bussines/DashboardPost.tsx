        ...
        <main className='px-4'>
            <div className='border rounded-3xl p-4 my-5'>
                <div className='flex justify-between'>
                    ...
                    <div >
                        <div onClick={() => setOpenApplications(prev => !prev)} className='flex gap-2 items-center cursor-pointer'>
                            <p>Bewerbungen ansehen</p>
                            <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path fill="none" stroke="#000" stroke-width="2" d="M4.99787498,8.99999999 L4.99787498,0.999999992 L19.4999998,0.999999992 L22.9999998,4.50000005 L23,23 L16,23 M18,1 L18,6 L23,6 M8,11 C6.34325,11 5,12.34325 5,14 C5,15.65675 6.34325,17 8,17 C9.65675,17 11,15.65675 11,14 C11,12.34325 9.65675,11 8,11 L8,11 Z M3,23 L3,22 C3,18 6,17 8,17 C10,17 13,18 13,22 L13,23 L3,23 Z"></path></svg>
                        </div>
                        <div className='flex justify-start gap-2 pb-5'>
                            <p>Bewerbungen:</p>
                            <p className='flex justify-center'>{applications.length} </p>
                        </div>
                    </div>
                </div>
                <div className='flex justify-between'>
